...
def spotify_handler(*args):
    ...
    global compilation_album
    global compilation_track_number
    ...
    # Maintain compilation_track_number if compilation_album
    if compilation_album == True:
        track_number = compilation_track_number
    ...
    if title != pre_title:
        ...
        if (artist != "") or (album != ""):
            ...
            advertisement_detected = False
            compilation_track_number = compilation_track_number + 1
